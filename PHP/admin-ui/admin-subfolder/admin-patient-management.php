<div id="admin-patient-page-id" class="information-record-main-container">
    ...
    <div class="information-record-container mt-4 border pt-2  ">
        ...
        <div class="count-show-container d-flex flex-row py-2">
            ...
            <div class="count-show-header ">Showing 50 of 231</div>
            ...
            <div
                ...
                <div class="col-12 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6 col-profile-box ">
                    <div class="profile-box" tabindex="0"
                        data-target="../../PHP/admin-ui/admin-subfolder/admin-patient-management-detailed.php" data-id="12345">
                        <div class="record-img-container">
                            <img id="profile-img-id" src="profile.jpg" alt="Profile Picture">
                        </div>
                        <div class="info-container ">
                            <h3 id="information-record-name-id">Dracy Malibu</h3>
                            <span id="inforamtion-record-pID-id">P-1002</span>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table record-list-view-tb mb-0" id="list-view-table-id">
                        ...
                        <tbody id="list-view-body-id">
                            <tr>
                                ...
                                <td>M-12356</td>
                                <td>09521457896</td>
                                <td>malibu.dracy@gmail.com</td>
                                <td>
                                    <div class="appointment-td-wrapper d-flex flex-row align-items-center">
                                        <p class="mb-0" id="td-total-appointment-id">15</p>
                                        <button type="button" class="ms-auto td-view-button "
                                            data-target="../../PHP/admin-ui/admin-subfolder/admin-patient-management-detailed.php">
                                            View Details
                                        </button>
                                    </div>
                                </td>

<div id="admin-staff-page-id" class="information-record-main-container">
    ...
    <div class="wrapper d-flex flex-wrap">
        <div class="profile-container ">
            <div class="header-text d-flex flex-row mb-2">
                ...
                <h3>Staff Information Records</h3>
            </div>
        ...
        <div class="add-user-btn-container ms-auto">
            <button class="add-user-btn" data-target="staff"><i class="fa-solid fa-user-plus"> </i> Add New Staff</button>
        </div>
    </div>
            ...
            <div
                ...
                <div class="col-12 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6 col-profile-box ">
                    <div class="profile-box" tabindex="0"
                        data-target="../../PHP/admin-ui/admin-subfolder/admin-staff-management-detailed.php" data-id="12345">
                        <div class="record-img-container">
                            <img id="profile-img-id" src="profile.jpg" alt="Profile Picture">
                        </div>
                        <div class="info-container ">
                            <h3 id="information-staff-record-name-id">Mikee Deleon</h3>
                            <span id="inforamtion-staff-record-sID-id">S-1002</span>
                        </div>
                    </div>
                </div>

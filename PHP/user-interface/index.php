...
<?php include '../../PHP/user-interface/navbar.php'; ?>
  ...
  <div class="hero-banner-container position-relative">

    <div class="banner fade active">
      <img src="../../Pictures/user-interface/banners-images-logo/header3.png" alt="Banner 1">
      <div class="banner-text-container">
        <div class="banner-text">
          <h2>Creating Confident Smiles Every Day</h2>
          <p>At MAPRU Dental Clinic, we combine modern dentistry with a personal touch, tailoring every treatment to
            your unique needs.</p>
        </div>
 ...
 <section class="about-section container-fluid py-5">
  ...
  <div class="col-lg-6 col-md-6 about-text">
        ...
        <p>
          Welcome to Mapru Dental Clinic, where your smile is our top priority. 
          Our clinic offers a wide range of dental services designed to meet the needs 
          of every patient, from routine checkups to advanced treatments. 
        </p>
        <p>
          We are committed to providing compassionate, personalized care in a modern 
          and comfortable environment. Our team of professionals uses the latest technology 
          to ensure the best results for your oral health.
        </p>
      </div>
    </div>
  </section>
  ...
  <section class="why-choose">
    ...
    <div class="grid-container">
      ...
      <div class="grid-item">
        ...
        <p>Led by Dra. Maja Prudente, our team is dedicated to providing high-quality dental services with honesty,
      ...
      <div class="grid-item">
        ...
        <p>We take the time to listen to your concerns, explain your treatment options clearly, and ensure you feel
      ...
      <div class="grid-item">
        ...
        <p>Whether it's a routine checkup or a more advanced procedure, you can always expect personalized care in a
  ...
  <section class="Clinic-Images">
    ...
    <div class="Clinic-Slideshow">
      <img class="Clinic-Slide" src="../../Pictures/user-interface/dental-look/Clinic1.png" alt="Pictures of Clinic">
      <img class="Clinic-Slide" src="../../Pictures/user-interface/dental-look/Clinic1.png" alt="Pictures of Clinic">
  ...
  <footer class="footer">
    <div class="footer-container">
      ...
      <div class="footer-section center">
        <img src="../../Pictures/user-interface/banners-images-logo/logo.png" alt="MAPRU Logo" class="footer-logo">
